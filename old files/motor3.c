...
#define MOTOR_RUN_TIME 5 // Time in seconds for 180 degrees rotation
...
int main(void)
{
    ...
    while (1) {
        printf("Enter command (1 for clockwise, 0 for counterclockwise, exit to quit): ");
        ...
        if (strncmp(command, "1", 1) == 0) {
            ...
            sleep(MOTOR_RUN_TIME); // Wait for 180-degree turn (adjust time as needed)
            stopMotor(); // Stop the motor after 180-degree turn
            ...
            printf("Unknown command. Use '1' for clockwise, '0' for counterclockwise, or 'exit' to quit.\n");
        }
    }
